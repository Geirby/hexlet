...
// foobarbaz
Cart.php
Реализуйте в классе Cart методы, определенные в интерфейсах \Countable и \IteratorAggregate. Метод count() должен возвращать
число товаров в корзине. Кроме того, если передать объект корзины в конструкцию foreach, то должны перечислиться все товары, находящиеся в ней.
